...
for(kk=1;kk<=10;kk++){		
	...
	sprintf(iperfshift4cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> shift4.txt  &  sudo ./real/real10 ", argv[2]);
	

	char iperflia4cmd[100] = "";
	sprintf(iperflia4cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> lia4.txt & sudo ./real/real10 ", argv[2]);

        char iperfshift2cmd[100] = "";
        sprintf(iperfshift2cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> shift2.txt & sudo ./real/real20", argv[2]);

	char iperflia2cmd[100] = "";
        sprintf(iperflia2cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> lia2.txt & sudo ./real/real20", argv[2]);


        char iperftcp1cmd[100] = "";
        sprintf(iperftcp1cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> tcp1.txt & sudo ./real/real40", argv[2]);

        char iperfdc1cmd[100] = "";
        sprintf(iperfdc1cmd, "iperf -c %s -n 1280M -f m |grep bits/sec >> dc1.txt & sudo ./real/real40", argv[2]);
